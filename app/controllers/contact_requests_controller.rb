class ContactRequestsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if verify_recaptcha(model: @contact_request) && @contact_request.save
        format.html { redirect_to 'pages/contact', notice: 'Contact request was successfully created.' }
  ...
  private
    ...
    def contact_request_params
      params.require(:contact_request).permit(:name, :email, :phone_no, :message)
    end
end
